          ...
          <div>
            ...
            <div className="flex flex-col gap-4 font-mono text-sm">
              <div className="flex justify-between items-center">
                ...
                <span className="text-recovered">PASS ({new Date(c.opened_at).toLocaleTimeString('en-IN', { timeZone: 'Asia/Kolkata', hour12: true, hour: '2-digit', minute: '2-digit' })} IST)</span>
              </div>
              <div className="flex justify-between items-center">
        ...
        <div className="sharp-card overflow-hidden">
          ...
          {c.interventions?.length ? c.interventions.map(int => (
            <div key={int.id} className="grid grid-cols-4 p-4 border-b border-border last:border-0 font-mono text-sm items-center">
              ...
              <div>{new Date(int.scheduled_for).toLocaleString('en-IN', { timeZone: 'Asia/Kolkata', month: 'short', day: 'numeric', hour: '2-digit', minute: '2-digit', hour12: true })}</div>
              <div>{int.executed_at ? new Date(int.executed_at).toLocaleString('en-IN', { timeZone: 'Asia/Kolkata', month: 'short', day: 'numeric', hour: '2-digit', minute: '2-digit', hour12: true }) : "—"}</div>
              <div>
