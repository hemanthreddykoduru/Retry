            ...
            filteredCases.map((c) => (
              ...
              >
                <div className="col-span-2 font-mono text-xs text-text-primary">
                  ...
                  <div className="text-text-muted mt-1 text-[10px]">{new Date(c.opened_at).toLocaleString('en-IN', { timeZone: 'Asia/Kolkata', month: 'short', day: 'numeric', hour: '2-digit', minute: '2-digit', hour12: true })}</div>
                </div>
