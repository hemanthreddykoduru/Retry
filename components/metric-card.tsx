export function MetricCard({
  ...
  return (
    <div className="bg-[#FFFFFF] border border-[#E6E8EC] p-5 rounded-none flex flex-col gap-3 shadow-[0_1px_2px_rgba(0,0,0,0.04)] transition-all hover:shadow-[0_4px_12px_rgba(0,0,0,0.05)]">
